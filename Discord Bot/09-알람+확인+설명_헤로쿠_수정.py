...
async def 설명(ctx):
    ...
    embed3 = discord.Embed(title="명령어 설명", description="꿔바로우봇의 명령어에 대한 설명입니다 ☆～（ゝ。∂）", color = 0x403DEA)
    embed3.add_field(name="❗알람 (아이디) (비밀번호) (알람을 울릴 시간)", value = "알람을 설정해두면 매일 그 시간에 메세지를 보내드려요! (알람 시간 예시: 00:20, 09:00, 22:00 등)", inline = False)
    embed3.add_field(name="❗확인 (아이디) (비밀번호)", value="100% 미만 진도율의 강의 목록과 미제출 과제 목록을 언제든 확인할 수 있어요! o(*'▽'*)/☆ﾟ’")
    embed3.set_thumbnail(url="https://w.namu.la/s/7504e0e9a2d890912ce2a3f26a02943c08b57ffabab09bafbeed76d3f4a0483710c1301b7196f0873de45a9ebd90dab177756d2b947ee11d362995dd91b33172acf30aab6b92e804528ac1dc841ce5ec1ca2c966f632688a2a90fd16e7f637eeb30f573e8d90a32726a56d3b19e254fc")
